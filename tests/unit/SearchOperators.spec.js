...
describe('Search Operators', function() {
  it('supports a "contains" operator', function() {
    ...
    expect(contains('Abc', 'A'))
    expect(contains('Abc', 'b'))
    expect(contains('Abc', 'c'))
  ...
  it('supports a "startsWith" operator', function() {
    ...
    expect(startsWith('Abc', 'A'))
    expect(startsWith('Abc', 'Ab'))
    expect(startsWith('Abc', 'Abc'))
  ...
  it('supports a "endsWith" operator', function() {
    ...
    expect(endsWith('Abc', 'bc'))
    expect(endsWith('Abc', 'Abc'))
